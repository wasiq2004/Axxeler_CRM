...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="h-screen flex bg-white font-sans overflow-hidden">
      {/* Left Column: Premium Branding & Visuals - Full Height, No Scroll */}
      <div className="hidden lg:flex lg:w-1/2 bg-[#021025] relative overflow-hidden flex-col justify-between p-12">
        <div className="absolute top-0 right-0 w-full h-full pointer-events-none">
          ...
          <div className="absolute bottom-[-10%] left-[-10%] w-[70%] h-[70%] bg-blue-400/5 blur-[180px] rounded-full animate-pulse delay-1000 opacity-50" />
        ...
        <div className="relative z-10 animate-slideDown">
          ...
          <h1 className="text-6xl font-black text-white leading-tight tracking-tighter mb-6 animate-fadeIn delay-300">
            Smart CRM <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00A3FF] to-[#0066FF]">Dashboard.</span>
          </h1>
          <p className="text-xl text-gray-400 font-medium max-w-md leading-relaxed animate-fadeIn delay-500">
            Experience the future of sales management with built-in automation.
          </p>
        </div>

        <div className="relative z-10 grid grid-cols-2 gap-8 max-w-lg mb-4 animate-fadeIn delay-700">
          <div className="space-y-3 group">
            <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center border border-white/10 shadow-2xl transition-all duration-300 group-hover:bg-blue-600/20 group-hover:scale-110">
              <Zap className="w-6 h-6 text-[#00A3FF]" />
            </div>
            <h3 className="text-white font-bold text-base">Fast Sync</h3>
            <p className="text-[10px] text-gray-500 font-black tracking-wider uppercase opacity-40 group-hover:opacity-100 transition-opacity">Meta & LinkedIn</p>
          </div>
          <div className="space-y-3 group">
            <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center border border-white/10 shadow-2xl transition-all duration-300 group-hover:bg-blue-600/20 group-hover:scale-110">
              <Sparkles className="w-6 h-6 text-[#00A3FF]" />
            </div>
            <h3 className="text-white font-bold text-base">AI Power</h3>
            <p className="text-[10px] text-gray-500 font-black tracking-wider uppercase opacity-40 group-hover:opacity-100 transition-opacity">Data Insights</p>
          </div>
        </div>
        ...
        <div className="relative z-10 flex items-center justify-between text-gray-600 pt-8 border-t border-white/5 animate-fadeIn delay-1000">
          <p className="text-[10px] font-black uppercase tracking-[0.5em] opacity-30">Management Excellence Platform</p>
      ...
      {/* Right Column: Compact Authentication Form - Full Height, No Scroll */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-[#F1F5F9]">
        <div className="w-full max-w-[420px]">
          <div className="bg-white rounded-[40px] shadow-[0_40px_120px_rgba(0,0,0,0.06)] border border-white p-8 sm:p-10 relative overflow-hidden animate-slideUp">
            ...
            <div className="relative z-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 stagger-container">
                  ...
                  <div className="space-y-2 animate-fadeIn delay-200">
                    ...
                    <div className="relative group">
                      ...
                      <button
                        ...
                        className="absolute right-5 top-1/2 -translate-y-1/2 text-gray-300 hover:text-blue-600 transition-all"
                      >
                ...
                <div className="flex items-center gap-3 group cursor-pointer w-fit px-2 animate-fadeIn delay-300">
                  ...
                  <label htmlFor="remember" className="text-[10px] font-black text-gray-400 cursor-pointer select-none uppercase tracking-widest transition-colors group-hover:text-gray-900">Remember Me</label>
                </div>

                <div className="pt-2 animate-fadeIn delay-400">
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full h-14 !bg-blue-600 hover:!bg-blue-800 text-white font-black text-xs uppercase tracking-[0.3em] rounded-[20px] shadow-[0_12px_32px_rgba(37,99,235,0.25)] active:scale-[0.98] transition-all flex items-center justify-center gap-2 group overflow-hidden"
                  >
                    {isLoading ? (
          ...
          <div className="mt-8 flex items-center justify-center gap-4 text-gray-300 opacity-50 animate-fadeIn delay-1000">
            ...
            <p className="text-[9px] font-black uppercase tracking-[0.5em] leading-none">Security Active</p>
          </div>
        </div>
      </div>
    </div>
