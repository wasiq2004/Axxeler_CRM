...
const users = [
  { id: 'user_1', name: 'Main Admin', email: 'admin@ziya.com', password: 'admin123', role: 'admin' as const, avatar: 'https://i.pravatar.cc/150?u=user_1' },
  { id: 'user_2', name: 'General Manager', email: 'manager@ziya.com', password: 'manager123', role: 'manager' as const, avatar: 'https://i.pravatar.cc/150?u=user_2' },
  { id: 'user_3', name: 'Senior Executive', email: 'team@ziya.com', password: 'team123', role: 'team_member' as const, avatar: 'https://i.pravatar.cc/150?u=user_3' },
];
...
async function main() {
  ...
  await prisma.notification.upsert({
    where: { id: 'notif_1' },
    update: {},
    create: { id: 'notif_1', type: 'general', title: 'Welcome', message: 'Backend seed data is ready.', isRead: false },
  });
}
